...
import qs from 'qs'
import {ID, QueryResponseContextProps, BasicQueryResponseContextProps, QueryState} from './models'

function createResponseContext<T>(initialState: QueryResponseContextProps<T>) {
  return createContext(initialState)
}

function createBasicResponseContext<T>(initialState: BasicQueryResponseContextProps<T>) {
  return createContext(initialState)
}
